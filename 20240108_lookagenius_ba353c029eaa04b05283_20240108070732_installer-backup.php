...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20240108_lookagenius_ba353c029eaa04b05283_20240108070732_archive.zip';
        const ARCHIVE_SIZE       = '158883706';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'ba353c0-08070732';
        const SECONDARY_PACKAGE_HASH = '4abe88d-08070732';
        const VERSION            = '1.5.7.1';
